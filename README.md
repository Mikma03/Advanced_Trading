...
- [Financial data resources and APIs](#financial-data-resources-and-apis)
- [Books fo quant trading and beyond](#books-fo-quant-trading-and-beyond)
- [Financial Engineering - courses](#financial-engineering---courses)
- [Quantitative Economics and Mathematics](#quantitative-economics-and-mathematics)
- [Advanced stochastic integrals and probability calculus](#advanced-stochastic-integrals-and-probability-calculus)
- [Quantitative Finance: Numerical-Methods](#quantitative-finance-numerical-methods)
- [Trading using Python - options and crypto](#trading-using-python---options-and-crypto)
- [GitHub repo's with quant resources: Trading](#github-repos-with-quant-resources-trading)
- [Article related to algo trading](#article-related-to-algo-trading)
- [YouTube Chanels](#youtube-chanels)
- [Websites for ML-quant: Trading](#websites-for-ml-quant-trading)
...
This repository is realization of advanced concepts and aspects regarding to trading strategies and financial engineering. In folders are material and code examples for different strategies and approaches.

As a part of this repository there is sub Reddit for the community.
...
Based on following book: **Mathematical Modeling and Computation in Finance** author created following courses avaiable on YouTube
...
# Advanced stochastic integrals and probability calculus
...
# Trading using Python - options and crypto

- Options trading using Python

  - https://www.codearmo.com/python/

- Crypto trading using Python
  - https://www.codearmo.com/python/crypto-algo-trading

# GitHub repo's with quant resources: Trading
...
https://learning.oreilly.com/library/view/machine-learning-for/9781801819626/

https://learning.oreilly.com/library/view/time-series-forecasting/9781617299889/

https://learning.oreilly.com/library/view/modern-time-series/9781803246802/

https://learning.oreilly.com/library/view/time-series-analysis/9781801075541/

https://learning.oreilly.com/library/view/time-series-algorithms/9781484289785/
